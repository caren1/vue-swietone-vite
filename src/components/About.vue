  ...
  <section class="min-h-screen flex justify-center items-center relative" id="about" >
    <div class="" data-aos="fade-right"
     ...
     data-aos-easing="ease-in-sine">
        <h1 class="text-white text-center text-xl font-serif mb-4 sm:text-2xl z-1 md:text-center md:text-4xl whatcanwedo">Co możemy dla Ciebie zrobić?</h1>
        <ul class="leading-[40px] xxs:leading-[40px] px-6 py-6 text-white text-[15px] font-sans font-thin ml-[1rem] xxs:text-sm sm:text-lg sm:leading-[50px] sm:ml-[1.5rem] md:leading-[45px] md:text-[20px] md:ml-24">
