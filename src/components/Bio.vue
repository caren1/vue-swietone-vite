    ...
    <div class=" flex-col relative z-5 sm:flex sm:flex-row sm:static" >
     ...
     data-aos-easing="ease-in-sine">
        ...
        <div class="text-[13px] md:text-[16px]">
          ...
          Obecnie pracuję na stanowisku Fullstack Developer w firmie Hapag-Lloyd, gdzie rozwijam platformę integrującą różnego rodzaju API.
          Wcześniej, przez 3 lata pracowałem jako Junior Java Engineer oraz Data Analyst, natomiast
          interesuję się również web development'em, jak i szeroko pojętym projektowaniem interfejsów użytkownika oraz designem.
        </p>
